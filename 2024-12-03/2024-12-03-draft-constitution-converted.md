...
action.
TheConstitutional Committee shall seek to reconcile such inconsistencies 
...
and voting on on-chain governance actions is open and transparent and is 
protected from undue influence and manipulation.
...
## ARTICLE IV. THE CARDANO BLOCKCHAIN BUDGET
...
budget through an on-chain "Info" action.
As provided in Section 3 of this Article IV, withdrawals may be made from the 
Cardano Blockchain treasury from time to time to give effect to a Cardano 
Blockchain budget then in effect.
...
being appointed a DRep by such ada owner or by its designee or for voting on 
behalf of such ada owner or its designee.
...
Cardano Blockchain budgets shall provide for periodic administrative costs of 
the Constitutional Committee in such amounts as requested from time to time by 
the Constitutional Committee and as approved by ada owners.
...
chain governance action that satisfies the applicable voting threshold as set 
forth in this Appendix.
Any such amendment to anyGuardrails shall require and be deemed to be an 
...
decentralization and protection against adversarial actions 2.
...
- *governance action deposit* (* gov ActionDeposit*)
- *DRep deposit amount* (*dRepDeposit*)
...
| **Cardano treasury**              | Means the decentralized on-chain ada management system that holds and releases ada received from transaction fees and monetary expansion.                                                                                                     |
| **Constitutional Committee (CC)** | Means the governing body responsible for determining that governance actions implemented on-chain are constitutional.                                                                                                                        |
...
| **Delegated Representative (DRep)** | Means an individual or entity who has registered to vote with respect to on-chain governance actions for its own behalf or on behalf of other owners of ada.                                                                               |
...
| **On-chain and off-chain**        | "On-chain" refers to governance actions which are implemented or otherwise recorded on the Cardano Blockchain, and "off-chain" refers to proposed governance actions which have not yet been implemented or otherwise recorded on the Cardano Blockchain or other types of governance related decisions that are not intended to be implemented or otherwise recorded on the Cardano Blockchain. |
...
| **Stake Pool Operator (SPO)**     | Means each person or entity running a Cardano block-producing node.                                                                                                                                                                         |
